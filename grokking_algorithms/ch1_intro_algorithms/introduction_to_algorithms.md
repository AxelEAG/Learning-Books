...
[**Binary search**](./binary_search.ipynb) - Search algorithm that given an input of a sorted list of elements and a target element, it will output the location of the target in the list (or if not there, null). 
